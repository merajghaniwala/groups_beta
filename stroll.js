...
this.element.addEventListener("touchend",this.touchEndDelegate,false);};c.prototype.onTouchStart=function(n){if(n.touches.length===1){this.touch.isActive=true;
...
clearInterval(this.touch.accellerateTimeout);if(Math.abs(this.velocity)>4||Math.abs(m)>10){}};c.prototype.update=function(q){var r=this.top.value+this.velocity+this.touch.offset;
